            ...
            {selectedTags.map((tag) => {
              ...
              return (
                <button
                  ...
                  disabled={isPending}
                  className="inline-flex cursor-pointer items-center gap-1 rounded-3xl bg-blue-100 px-3 py-1 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-200 disabled:opacity-50"
                >
                  {label}
                  <X className="h-3 w-3" />
                </button>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {!showCustomInput && (
            <button
              ...
              disabled={isPending}
              className="inline-flex cursor-pointer items-center gap-1 rounded-3xl border border-dashed border-neutral-400 bg-white px-4 py-2 text-sm font-medium text-neutral-600 transition-colors hover:border-blue-400 hover:bg-blue-50 hover:text-blue-700 disabled:opacity-50"
            >
